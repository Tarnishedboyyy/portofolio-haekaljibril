...
```bash
git remote add encore encore://photography-videography-portfolio-t5n2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/photography-videography-portfolio-t5n2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/photography-videography-portfolio-t5n2/settings/integrations/github)
